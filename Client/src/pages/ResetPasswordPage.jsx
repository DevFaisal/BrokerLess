      ...
      {error ? (
        ...
        <Container>
          <div className="flex items-center justify-center h-screen w-full">
            <div
              className="flex flex-col  items-center justify-start w-1/3  p-10 border bg-white border-gray-300 rounded-md
                        shadow-md hover:shadow-lg transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105
                        "
            >
              <h1 className="text-3xl font-bold mb-32">Reset Password</h1>
              <label className=" w-full text-black font-bold">
                Enter new password
              </label>
              <input
